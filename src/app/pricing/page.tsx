        ...
        data={[
          ...
          offerCatalogSchema({
            ...
            offers: [
              ...
              { name: "Camp Stay Room, 7 nights", price: roomNormal.tiers[0].basePrice, description: "7 nights in a standard room at Plai Laem with unlimited group training, flexible dates" },
              { name: "Camp Stay Room, 1 month", price: roomNormal.tiers[2].basePrice, description: "30 nights in a standard room at Plai Laem with unlimited group training, flexible dates" },
              { name: "Camp Stay Bungalow, 1 month", price: bungalowNormal.tiers[0].basePrice, description: "30 nights in the private bungalow at Plai Laem with unlimited group training, flexible dates" },
              { name: "Fighter Program + Room, 1 month", price: roomFighter.tiers[0].basePrice, description: "Fighter program plus 30 nights in a standard room at Plai Laem" },
              { name: "Fighter Program + Bungalow, 1 month", price: bungalowFighter.tiers[0].basePrice, description: "Fighter program plus 30 nights in the private bungalow at Plai Laem" },
            ],
          }),
        ]}
      />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <GlassCard>
              ...
              <div className="mb-1">
                <span className="font-serif text-4xl font-bold text-primary">{fmt(roomNormal.tiers[0].basePrice)} THB</span>
              </div>
            ...
            <GlassCard className="ring-2 ring-primary">
              ...
              <div className="mb-1">
                <span className="font-serif text-4xl font-bold text-primary">{fmt(roomNormal.tiers[1].basePrice)} THB</span>
              </div>
            ...
            <GlassCard>
              ...
              <div className="mb-1">
                <span className="font-serif text-4xl font-bold text-primary">{fmt(roomNormal.tiers[2].basePrice)} THB</span>
              </div>
            ...
            <GlassCard>
              ...
              <div className="mb-1">
                <span className="font-serif text-4xl font-bold text-primary">{fmt(bungalowNormal.tiers[0].basePrice)} THB</span>
              </div>
          ...
          <p className="text-center mt-8 text-on-surface-variant text-sm">
            ...
            {" "}({fmt(roomFighter.tiers[0].basePrice)} THB/month with a room, {fmt(bungalowFighter.tiers[0].basePrice)} THB/month with the bungalow).
          </p>
        </div>
      </section>
