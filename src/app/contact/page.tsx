...
const contactInfo = [
  ...
  },
  {
    icon: Clock,
    label: "Hours",
    value: "7:00 AM - 8:00 PM, 6 days/week (closed Sunday)",
    href: null,
  },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <LocationCard
              ...
              email="chor.ratchawat@gmail.com"
              hours="7:00 AM - 8:00 PM, 6 days/week (closed Sunday)"
      ...
      <section className="py-12 px-6 sm:px-10 md:px-16 lg:px-20">
        <div className="max-w-3xl mx-auto">
          <p className="text-on-surface-variant text-base leading-relaxed text-center">
            ...
            (Plai Laem Soi 13). Open 6 days a week (closed Sunday), training from 7:00 AM to 8:00 PM.
          </p>
        </div>
      </section>
